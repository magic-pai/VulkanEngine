...
struct RendererSsrStats {
    ...
    u32 fidelityFxSssrReprojectBypassEnabled = 0u;
    u32 fidelityFxSssrPrefilterBypassEnabled = 0u;
    u32 fidelityFxSssrResolveTemporalBypassEnabled = 0u;
    u32 fidelityFxSssrMirrorDnsrPassthroughRequested = 0u;
    u32 fidelityFxSssrMirrorDnsrPassthroughResourcesReady = 0u;
    u32 fidelityFxSssrMirrorDnsrPassthroughActive = 0u;
    u32 fidelityFxSssrMirrorDnsrRoughnessThresholdMilliunits = 80u;
    u32 fidelityFxSssrMirrorDnsrConfidenceThresholdPermille = 995u;
    u32 fidelityFxSssrConfidenceSpatialFilterEnabled = 0u;
    ...
    u32 fidelityFxSssrRadianceSanitizationEnabled = 1u;
    ...
    u32 fidelityFxSssrBlueNoiseResourcesReady = 0;
    u32 fidelityFxSssrBlueNoiseDescriptorSetsReady = 0;
    u32 fidelityFxSssrBlueNoisePipelineReady = 0;
    u32 fidelityFxSssrBlueNoiseDispatches = 0;
    u32 fidelityFxSssrBlueNoiseDescriptorBinds = 0;
    u32 fidelityFxSssrBlueNoiseWidth = 0;
    u32 fidelityFxSssrBlueNoiseHeight = 0;
    u32 fidelityFxSssrBlueNoiseGroupCountX = 0;
    u32 fidelityFxSssrBlueNoiseGroupCountY = 0;
    u32 fidelityFxSssrBlueNoiseSobolEntryCount = 0;
    u32 fidelityFxSssrBlueNoiseRankingTileEntryCount = 0;
    u32 fidelityFxSssrBlueNoiseScramblingTileEntryCount = 0;
    u64 fidelityFxSssrBlueNoiseMemoryBytes = 0;
    u32 fidelityFxSssrIntersectResourcesReady = 0;
    u32 fidelityFxSssrIntersectDescriptorSetsReady = 0;
    u32 fidelityFxSssrIntersectPipelineReady = 0;
    u32 fidelityFxSssrIntersectInputContractReady = 0;
    u32 fidelityFxSssrIntersectDispatches = 0;
    u32 fidelityFxSssrIntersectDescriptorBinds = 0;
    u32 fidelityFxSssrIntersectWidth = 0;
    u32 fidelityFxSssrIntersectHeight = 0;
    u32 fidelityFxSssrIntersectDepthPyramidMipCount = 0;
    u32 fidelityFxSssrReprojectResourcesReady = 0;
    u32 fidelityFxSssrReprojectDescriptorSetsReady = 0;
    u32 fidelityFxSssrReprojectPipelineReady = 0;
    u32 fidelityFxSssrReprojectInputContractReady = 0;
    u32 fidelityFxSssrReprojectDispatches = 0;
    u32 fidelityFxSssrReprojectDescriptorBinds = 0;
    u32 fidelityFxSssrReprojectWidth = 0;
    u32 fidelityFxSssrReprojectHeight = 0;
    u32 fidelityFxSssrReprojectAverageWidth = 0;
    ...
    u32 fidelityFxSssrZeroConfidenceHistoryRejectionEnabled = 1;
    ...
    u32 fidelityFxSssrResolveTemporalResourcesReady = 0;
    u32 fidelityFxSssrResolveTemporalDescriptorSetsReady = 0;
    u32 fidelityFxSssrResolveTemporalPipelineReady = 0;
    u32 fidelityFxSssrResolveTemporalInputContractReady = 0;
    u32 fidelityFxSssrResolveTemporalHistoryWritebackReady = 0;
    u32 fidelityFxSssrResolveTemporalDispatches = 0;
    u32 fidelityFxSssrResolveTemporalDescriptorBinds = 0;
    u32 fidelityFxSssrResolveTemporalWidth = 0;
    u32 fidelityFxSssrResolveTemporalHeight = 0;
...
struct RendererHybridReflectionStats {
    ...
    u32 skinnedBlasControlDisabled = 0;
    u32 skinnedCandidateCount = 0;
    u32 skinnedEligibleCount = 0;
    u32 skinnedTlasInstanceCount = 0;
    u32 skinnedDynamicBlasCount = 0;
    u32 skinnedDynamicBlasBuildCount = 0;
    u32 skinnedDynamicBlasUpdateCount = 0;
    u32 skinnedDynamicBlasReuseCount = 0;
    u32 skinnedSkinningDispatchCount = 0;
    u32 skinnedSkinningVertexCount = 0;
    u64 skinnedSkinningBufferBytes = 0;
    u64 skinnedPaletteSnapshotBytes = 0;
    u64 skinnedPoseRevisionMin = 0;
    u64 skinnedPoseRevisionMax = 0;
    u64 skinnedOutputRevisionMin = 0;
    u64 skinnedOutputRevisionMax = 0;
    u64 skinnedBlasRevisionMin = 0;
    u64 skinnedBlasRevisionMax = 0;
    u32 skinnedPoseBlasRevisionMismatchCount = 0;
    u32 skinnedInvalidPaletteCount = 0;
    u32 skinnedSkinningReadbackValid = 0;
    u32 skinnedSkinningReadbackVertexCount = 0;
    u32 skinnedSkinningReadbackSkinnedVertexCount = 0;
    u32 skinnedSkinningReadbackUnweightedVertexCount = 0;
    u32 skinnedSkinningReadbackInvalidBoneIndexCount = 0;
    u32 skinnedSkinningReadbackNonFiniteVertexCount = 0;
    ...
    u32 rayQueryInstanceMetadataResourcesReady = 0;
    u32 rayQueryInstanceMetadataCount = 0;
    u32 rayQueryInstanceMetadataCapacity = 0;
    u32 rayQueryInstanceMaterialCount = 0;
    ...
    u32 rayQueryHitLightingResourcesReady = 0;
    u32 rayQueryLightBufferDescriptorReady = 0;
    u32 rayQueryIblBrdfDescriptorReady = 0;
    u32 rayQueryIblIrradianceDescriptorReady = 0;
    u32 rayQueryIblPrefilteredDescriptorReady = 0;
    u32 rayQueryIblSamplerDescriptorReady = 0;
    u32 rayQueryIblPrefilteredMipCount = 0;
    u32 rayQueryLocalProbeIblContractVersion = 0;
    u32 rayQueryLocalProbeIblResourcesReady = 0;
    u32 rayQueryLocalProbeIblEnabled = 0;
    u32 rayQueryLocalProbeCount = 0;
    u32 rayQueryLocalProbePrefilteredReadyMask = 0;
    u32 rayQueryLocalProbeDiffuseReadyMask = 0;
    u32 rayQueryLocalProbeDescriptorWriteCount = 0;
    u32 rayQuerySourceFusionEnabled = 0;
    u32 rayQueryDirectMirrorEnabled = 1;
    u32 rayQueryScreenHitConfidenceThresholdPermille = 0;
    u32 rayQueryDirectionalLightCount = 0;
    ...
    u32 rayQueryHitAttributeResolvedCount = 0;
    u32 rayQueryHitAttributeInvalidInstanceCount = 0;
    u32 rayQueryHitAttributeInvalidPrimitiveCount = 0;
    u32 rayQueryHitAttributeInvalidVertexCount = 0;
    u32 rayQueryHitAttributeInvalidBarycentricCount = 0;
    u32 rayQueryHitAttributeInvalidValueCount = 0;
    u32 rayQueryHitAttributeMaterialResolvedCount = 0;
    u32 rayQueryHitAttributeMaterialFallbackCount = 0;
    u32 rayQueryHitAttributePositionMismatchCount = 0;
    u32 rayQueryHitAttributePositionErrorMaxMicrometers = 0;
    u32 rayQueryHitAttributeNormalLengthMinPermille = 0;
    u32 rayQueryHitAttributeNormalLengthMaxPermille = 0;
    u32 rayQueryHitAttributeBarycentricSumMinPermille = 0;
    u32 rayQueryHitAttributeBarycentricSumMaxPermille = 0;
    ...
    u32 rayQueryHitLightingResolvedCount = 0;
    u32 rayQueryHitLightingInvalidCount = 0;
    u32 rayQueryDirectionalLightEvaluationCount = 0;
    u32 rayQueryDirectionalLightContributionCount = 0;
    u32 rayQueryPointLightEvaluationCount = 0;
    u32 rayQueryPointLightContributionCount = 0;
    u32 rayQuerySpotLightEvaluationCount = 0;
    u32 rayQuerySpotLightContributionCount = 0;
    u32 rayQueryRectLightEvaluationCount = 0;
    u32 rayQueryRectLightContributionCount = 0;
    u32 rayQueryFiniteDirectRadianceCount = 0;
    u32 rayQueryFiniteIblRadianceCount = 0;
    u32 rayQueryLocalProbeIblResolvedCount = 0;
    u32 rayQueryGlobalIblFallbackCount = 0;
    u32 rayQueryLocalProbeIblInvalidCount = 0;
    u32 rayQueryLocalProbeIblLuminanceSumMilliunits = 0;
    u32 rayQuerySourceFusionCount = 0;
    u32 rayQuerySourceFusionConfidenceSumPermille = 0;
    u32 rayQuerySourceFusionScreenWeightSumPermille = 0;
    u32 rayQueryDirectMirrorCandidateCount = 0;
    u32 rayQueryDirectMirrorHitCount = 0;
    u32 rayQueryDirectMirrorFallbackCount = 0;
    u32 rayQueryFiniteEmissiveRadianceCount = 0;
    u32 rayQueryFiniteRadianceCount = 0;
    u32 rayQueryDirectLuminanceSumMilliunits = 0;
    u32 rayQueryIblLuminanceSumMilliunits = 0;
    u32 rayQueryEmissiveLuminanceSumMilliunits = 0;
...
struct RendererReflectionProbeStats {
    ...
    u32 capturedSceneLocalLightIdentityMask = 0;
    u32 capturedSceneGeometryIdentityMask = 0;
    u32 capturedSceneLocalLightRegionMask = 0;
    u32 capturedSceneGeometryRegionMask = 0;
    u32 capturedSceneDirtyLocalLightCount = 0;
    u32 capturedSceneDirtyRenderableCount = 0;
    ...
    u32 capturedSceneLocalLightDirty = 0;
    u32 capturedSceneGeometryDirty = 0;
    u32 capturedSceneLocalityIgnoredLightRevision = 0;
    u32 capturedSceneLocalityIgnoredGeometryRevision = 0;
    u32 capturedSceneLocalityIgnoredLightRevisionCount = 0;
    u32 capturedSceneLocalityIgnoredGeometryRevisionCount = 0;
    u32 capturedSceneDirtyLocalLightProbeCount = 0;
    u32 capturedSceneDirtyGeometryProbeCount = 0;
...
struct RendererBindStats {
    ...
    u32 ffxSssrBlueNoiseDispatches = 0;
    u32 ffxSssrBlueNoiseDescriptorBinds = 0;
    u32 ffxSssrBlueNoiseGroupCountX = 0;
    u32 ffxSssrBlueNoiseGroupCountY = 0;
    u32 ffxSssrIntersectDispatches = 0;
    ...
    u32 framePointLightCount = 0;
    u32 frameSpotLightCount = 0;
    u32 framePointSpotDirectSpecularEnabledCount = 0;
    u32 framePointSpotDirectSpecularDisabledCount = 0;
