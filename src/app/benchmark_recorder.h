...
struct BenchmarkSceneDiagnostics {
    ...
    u32 runtimeImportLodCacheRequested = 0;
    u32 runtimeImportLodCacheHit = 0;
    u32 runtimeImportLodCacheMiss = 0;
    u32 runtimeImportLodCacheRejected = 0;
    u32 runtimeImportLodCacheWritten = 0;
    u32 runtimeImportLodCacheFallbackReason = 0;
    u32 runtimeImportLodCacheableMeshCount = 0;
    u32 runtimeImportLodCacheDecodedChainCount = 0;
    u32 runtimeImportLodCacheDecodedLevelCount = 0;
    u64 runtimeImportLodCacheSourceFileBytes = 0;
    u64 runtimeImportLodCacheSourceHash = 0;
    u64 runtimeImportLodCacheSettingsHash = 0;
    u64 runtimeImportLodCacheKeyHash = 0;
    u64 runtimeImportLodCacheRawBytes = 0;
    u64 runtimeImportLodCacheEncodedBytes = 0;
    u64 runtimeImportLodCacheFileBytes = 0;
    u64 runtimeImportLodCacheSourceHashMicroseconds = 0;
    u64 runtimeImportLodCacheReadMicroseconds = 0;
    u64 runtimeImportLodCacheDecodeMicroseconds = 0;
    u64 runtimeImportLodCacheBuildMicroseconds = 0;
    u64 runtimeImportLodCacheWriteMicroseconds = 0;
    u64 runtimeImportLodCacheImportMicroseconds = 0;
    u64 runtimeImportLodCacheTotalLoadMicroseconds = 0;
    ...
    // Runtime scene-building tool observability. Passive counters only.
    u32 sceneBuilderAvailable = 0;
    u32 sceneBuilderPrimitiveAvailabilityMask = 0;
    u32 sceneBuilderObjectCount = 0;
    u32 sceneBuilderCreatedObjectCount = 0;
    u32 sceneBuilderDestroyedObjectCount = 0;
    u32 sceneBuilderLightCount = 0;
    u32 sceneBuilderCreatedLightCount = 0;
    u32 sceneBuilderDestroyedLightCount = 0;
    u32 sceneBuilderLiveMaterialCount = 0;
    u32 sceneBuilderMaterialLibraryCount = 0;
    u32 sceneBuilderFrameMaterialBudget = 0;
    u32 sceneBuilderSceneRenderableCount = 0;
    u64 sceneBuilderSelectedIdentity = 0;
    u64 sceneBuilderSelectedLightIdentity = 0;
    u32 sceneBuilderSelectedPrimitive = 0;
    u64 sceneBuilderEditRevision = 0;
    u32 sceneBuilderTransformEditCount = 0;
    u32 sceneBuilderMaterialEditCount = 0;
    u32 sceneBuilderLightEditCount = 0;
    u32 sceneBuilderRenameCount = 0;
    u32 sceneBuilderSelectionSyncCount = 0;
    u32 sceneBuilderSelectionShortcutDeleteCount = 0;
    u32 sceneBuilderMaterialDescriptorRefreshCount = 0;
    u32 sceneBuilderLastCreateFailure = 0;
    u32 sceneBuilderCreateFailureCount = 0;
    u32 sceneBuilderBlendObjectCount = 0;
    u32 sceneBuilderEnvironmentIblEnabled = 1;
    u32 sceneBuilderEnvironmentSkyboxEnabled = 0;
    f32 sceneBuilderEnvironmentDiffuseIntensity = 1.0f;
    f32 sceneBuilderEnvironmentSpecularIntensity = 1.0f;
    f32 sceneBuilderEnvironmentHorizonBlend = 0.22f;
    f32 sceneBuilderEnvironmentSkyboxIntensity = 1.0f;
    f32 sceneBuilderEnvironmentSkyboxBlur = 0.0f;
    u32 sceneBuilderEnvironmentLightingAsset = 0;
    u32 sceneBuilderCubeCount = 0;
    u32 sceneBuilderPlaneCount = 0;
    u32 sceneBuilderSphereCount = 0;
    u32 sceneBuilderConeCount = 0;
    u32 sceneBuilderDirectionalLightCount = 0;
    u32 sceneBuilderPointLightCount = 0;
    u32 sceneBuilderSpotLightCount = 0;
    u32 sceneBuilderRectLightCount = 0;
    u32 sceneBuilderSelfTestRan = 0;
    u32 sceneBuilderSelfTestPassed = 0;
    u32 sceneBuilderSelfTestFailedCheckMask = 0;
